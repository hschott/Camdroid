...
public class SystemUiHiderHoneycomb extends SystemUiHiderBase {
		...
		public void onSystemUiVisibilityChange(int vis) {
			...
			if ((vis & SystemUiHiderHoneycomb.this.mTestFlags) != 0) {
				if (Build.VERSION.SDK_INT < Build.VERSION_CODES.JELLY_BEAN) {
					// Pre-Jelly Bean, we must manually use the old window flags
					// API.
				...
				// state.
				SystemUiHiderHoneycomb.this.mOnVisibilityChangeListener
	 ...
	 */
	protected SystemUiHiderHoneycomb(Activity activity, int flags) {
		...
		if ((this.mFlags & FLAG_FULLSCREEN) != 0) {
			...
			this.mShowFlags |= View.SYSTEM_UI_FLAG_FULLSCREEN;
			this.mHideFlags |= View.SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN
					| View.SYSTEM_UI_FLAG_FULLSCREEN;
			this.mTestFlags |= View.SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN;
		}

		if ((this.mFlags & FLAG_HIDE_NAVIGATION) != 0) {
			// If the client requested hiding navigation, add relevant flags.
			this.mShowFlags |= View.SYSTEM_UI_FLAG_HIDE_NAVIGATION;
			this.mHideFlags |= View.SYSTEM_UI_FLAG_LAYOUT_HIDE_NAVIGATION
					| View.SYSTEM_UI_FLAG_HIDE_NAVIGATION;
			this.mTestFlags |= View.SYSTEM_UI_FLAG_LAYOUT_HIDE_NAVIGATION;
		}

		// if ((this.mFlags & FLAG_IMMERSIVE) != 0) {
		// this.mHideFlags |= View.SYSTEM_UI_FLAG_IMMERSIVE;
		// }
		//
		// if ((this.mFlags & FLAG_IMMERSIVE_STICKY) != 0) {
		// this.mHideFlags |= View.SYSTEM_UI_FLAG_IMMERSIVE_STICKY;
		// }
	}
	...
	public void hide() {
		this.mActivity.getWindow().getDecorView()
				.setSystemUiVisibility(this.mHideFlags);
	}
	...
	protected void setup() {
		...
		this.mActivity
				...
				.setOnSystemUiVisibilityChangeListener(
						this.mSystemUiVisibilityChangeListener);
	}
